...
2. STAGE 플랫폼 설치
   ...
   3. 테스트 실행
        ...
        의 결과를 확인 하실 수 있습니다. *Ctrl+C*를 통해 Docker를 중지합니다.
...
4. 참고 사항
    ...
    1. BSON
       ...
       STAGE플랫폼은 외부 통신을 위해 [BSON](http://bsonspec.org/) 형태로 데이터를 주고 받습니다.


    2. odbc 사용

       STAGE플랫폼은 ODBC연결을 위한 queryDriver 설정을 MS-SQL과 MySQL를 선택적으로 사용 할 수 있도록 하였습니다.
