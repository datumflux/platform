...
> 우리는 비 전문가도 개발할 수 있는 플랫폼을 제공하기 위해 노력을 합니다. 

서버 개발에 대해서는 비 전문가라고 하더라도 **콘텐츠를 개발하는 개발자는 전문가를 대상**으로 합니다. 전문가의 아이디어와 의도를 그대로 담아내야 하기에 단순한 형태의 툴이 아닌 프로그래밍에 대한 요소가 상당히 많은 부분을 차지 합니다.
